...
export const tenantApi = {
  ...
  getDetails: (tenantId) => unwrap(client.get(`/tenant/${tenantId}`)),
};
...
export const attendanceApi = {
  ...
  history: (params) =>
    unwrap(client.get("/attendance/attendance-history", { params })),
};
...
export const memberSlotApi = {
  ...
  getByMember: (memberId) => unwrap(client.get(`/member-slot/${memberId}`)),
...
export const memberMembershipApi = {
  ...
  getByMember: (memberId) =>
    unwrap(client.get(`/member-membership/member/${memberId}`)),
  getById: (id) => unwrap(client.get(`/member-membership/${id}`)),
  update: (id, payload) =>
    unwrap(client.patch(`/member-membership/${id}`, payload)),
  deactivate: (id) =>
    unwrap(client.patch(`/member-membership/${id}/deactivate`)),
  freeze: (id, payload) =>
    unwrap(client.patch(`/member-membership/${id}/freeze`, payload)),
};
...
export const healthProfileApi = {
  create: (payload) => unwrap(client.post("/health-profile", payload)),

  list: () => unwrap(client.get("/health-profile")),

  getByBranch: (branchId) =>
    unwrap(client.get(`/health-profile/branch/${branchId}`)),

  getById: (id) => unwrap(client.get(`/health-profile/${id}`)),

  update: (id, payload) =>
    unwrap(client.patch(`/health-profile/${id}`, payload)),

  remove: (id) => unwrap(client.delete(`/health-profile/${id}`)),
};

// ---------- Measurements ----------
export const measurementApi = {
  create: (payload) => unwrap(client.post("/measurements", payload)),

  list: () => unwrap(client.get("/measurements")),

  getByBranch: (branchId) =>
    unwrap(client.get(`/measurements/branch/${branchId}`)),

  getById: (id) => unwrap(client.get(`/measurements/${id}`)),

  update: (id, payload) => unwrap(client.patch(`/measurements/${id}`, payload)),

  remove: (id) => unwrap(client.delete(`/measurements/${id}`)),
};

// ---------- Diet Plans ----------
export const dietPlanApi = {
  create: (payload) => unwrap(client.post("/diet-plans", payload)),
...
export const dietPlanMealApi = {
  ...
  list: () => unwrap(client.get("/diet-plan-meals")),

  getById: (id) => unwrap(client.get(`/diet-plan-meals/${id}`)),

  update: (id, payload) =>
    unwrap(client.put(`/diet-plan-meals/${id}`, payload)),

  remove: (id) => unwrap(client.delete(`/diet-plan-meals/${id}`)),
};

// ---------- Exercises ----------
export const exerciseApi = {
  create: (payload) => unwrap(client.post("/exercises", payload)),

  list: () => unwrap(client.get("/exercises")),

  getById: (id) => unwrap(client.get(`/exercises/${id}`)),

  update: (id, payload) => unwrap(client.patch(`/exercises/${id}`, payload)),

  remove: (id) => unwrap(client.delete(`/exercises/${id}`)),
};

// ---------- Workout Plans ----------
export const workoutPlanApi = {
  create: (payload) => unwrap(client.post("/workout-plans", payload)),
...
export const workoutPlanExerciseApi = {
  ...
  list: () => unwrap(client.get("/workout-plan-exercises")),

  getById: (id) => unwrap(client.get(`/workout-plan-exercises/${id}`)),
